...
function Team() {
  ...
  return (
    <div className={styles.team} id='team'>
      ...
      <h1>Meet the Team</h1>
      <Spacer y={1} />
      <Grid.Container  css={{ w:'65%'}} gap={2} justify='space-around' >
        {/**<Grid xs={6} justify='end' >*/}
          ...
          <Grid gap={5} xs={12} sm={6} key={index} css={{border: '$space$1 solid white' }}>
            <Card css={{ w: '35%',  borderRadius: '0'}}>
                ...
                <Divider />
                <Card.Body css={{ py: '$10' }}>
                  {/* <Image objectFit='scale-down' src={item.img} alt='logo-gif'/> */}
  ...
  {/**<Grid>*/}
          {/* <Grid xs={6} justify='start' > */}
            {/* <Grid xs={12} sm={6} css={{border: '$space$1 solid white' }}>
              <Card css={{ w: '35%', borderRadius: '0'}}>
                <Card.Header>
                  <Text b size={20}>
                  Johnson Che
                ...
                <Divider />
                <Card.Body css={{ py: '$10' }}>
                  <Image layout='responsive' src={JC} alt='logo-gif'/>
                </Card.Body>
                <Card.Footer>
          ...
          {/* <Grid xs={6} justify='end' > */}
            {/* <Grid xs={12} sm={6} css={{border: '$space$1 solid white' }}>
              <Card css={{ w: '35%', borderRadius: '0'  }}>
                ...
                <Divider />
                  <Card.Body css={{ py: '$10' }}>
                  <Image layout='responsive' src={NG} alt='logo-gif'/>
                  </Card.Body>
                  <Card.Footer>
                  <Row justify='space-around'>
            ...
            {/* <Grid xs={6} justify='start' > */}
              {/* <Grid xs={12} sm={6} css={{border: '$space$1 solid white' }}>
                <Card css={{ w: '35%', borderRadius: '0'  }}>
                  ...
                  <Divider />
                  <Card.Body css={{ py: '$10' }}>
                    <Image layout='responsive' src={QC} alt='logo-gif'/>
                  </Card.Body>
                  <Card.Footer>
                    <Row justify='space-around'>
